...
Instrumentalness
Timbre coefficient 6
Duration
Timbre coefficient 4
We can use these features for a reduced knn classifier. The duration probably makes it easy to find the extended versions of songs in the playlist.
...
This playlist started as a passion project during the first lockdown, and it's funny to see how it became my university project during another lockdown. I hope to enjoy some of the remixes in a club when that's possible again. MEROL beautifully expressed this sentiment in "knaldrang", so I'll live you with that.

 ```{=html}
<object data="https://open.spotify.com/embed/track/0ekV6d6sL5dtjhsMUG6kTT" width="300" height="380">
    <embed src="https://open.spotify.com/embed/track/0ekV6d6sL5dtjhsMUG6kTT" width="300" height="380"></embed>
</object>
 ```