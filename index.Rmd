...
Tracks are remixed for a wide amount of reasons, but one of them is for them to be played in a night club. This means there is probably some change in tempo. 
...
The top 10 least changed remixes in terms of Spotify determined energy include several extended versions of songs (Circus, Flame, Better When You're Gone, Don't Start Now and Toxic), it makes sense that an extended version of a song is not drastically different from the original.